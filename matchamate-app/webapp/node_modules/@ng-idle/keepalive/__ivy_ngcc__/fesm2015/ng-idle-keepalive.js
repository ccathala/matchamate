...
let Keepalive = class Keepalive extends KeepaliveSvc {
    /*
...
Keepalive.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Keepalive, factory: function (t) { return Keepalive.ɵfac(t); } });
Keepalive.ctorParameters = () => [
    { type: HttpClient },
    { type: NgZone }
];
Keepalive = __decorate([ __metadata("design:paramtypes", [HttpClient, NgZone])
], Keepalive);

var NgIdleKeepaliveModule_1;
let NgIdleKeepaliveModule = NgIdleKeepaliveModule_1 = class NgIdleKeepaliveModule {
    static forRoot() {
        return {
