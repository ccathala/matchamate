...
LocalStorage.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: LocalStorage, factory: function (t) { return LocalStorage.ɵfac(t); } });
LocalStorage = __decorate([ __metadata("design:paramtypes", [])
], LocalStorage);
...
LocalStorageExpiry.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: LocalStorageExpiry, factory: function (t) { return LocalStorageExpiry.ɵfac(t); } });
LocalStorageExpiry.ctorParameters = () => [
    { type: LocalStorage }
];
LocalStorageExpiry = __decorate([ __metadata("design:paramtypes", [LocalStorage])
], LocalStorageExpiry);
...
Idle.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: Idle, factory: function (t) { return Idle.ɵfac(t); } });
Idle.ctorParameters = () => [
    { type: IdleExpiry },
    { type: NgZone },
    { type: KeepaliveSvc, decorators: [{ type: Optional }] }
];
Idle = __decorate([ __param(2, Optional()),
...
var NgIdleModule_1;
let NgIdleModule = NgIdleModule_1 = class NgIdleModule {
    static forRoot() {
        return {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LocalStorageExpiry, [{
        type: Injectable
    }], function () { return [{ type: LocalStorage }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(Idle, [{
        type: Injectable
    }], function () { return [{ type: IdleExpiry }, { type: ɵngcc0.NgZone }, { type: KeepaliveSvc, decorators: [{
                type: Optional
            }] }]; }, null); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgIdleModule, [{
        type: NgModule,
        args: [{
